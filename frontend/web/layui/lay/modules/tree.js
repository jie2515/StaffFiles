...
;layui.define("form", function (e) {
    ...
    var i = layui.$, a = layui.form, n = layui.layer, t = "tree", r = {
        ...
        y = "layui-tree-txt", z = "layui-tree-txt2", v = "layui-tree-pack", C = "layui-tree-spread",
    ...
    b.prototype.config = {
        ...
        layui.each(r, function (a, r) {
            var l = r.children && r.children.length > 0,
                ...
                h = i(['<div data-id="' + r.id + '" class="layui-tree-set' + (r.spread ? " layui-tree-spread" : "") + (r.checked ? " layui-tree-checkedFirst" : "") + '">', '<div class="layui-tree-entry">', '<div class="layui-tree-main">', function () {
                    ...
                    return t.showCheckbox ? '<label><input type="checkbox" onclick="check(this)" name="' + (r.field || "layuiTreeCheck_" + r.id) + '" same="layuiTreeCheck" lay-skin="primary" ' + (r.disabled ? "disabled" : "") + ' value="' + r.id + '"></label>' : ""
                }(), function () {
                    // return t.isJump && r.href ? '<a href="' + r.href + '" target="_blank" class="' + y + '">' + (r.title || r.label || t.text.defaultNodeName) + "</a>" : '<span class="' + y + (r.disabled ? " " + d : "") + '">' + (r.title || r.label || t.text.defaultNodeName) + "</span>"
                    return '<a id="url_' + r.id + '" href="' + r.href + '" target="_blank" class="' + y + '">' + (r.title || r.label || t.text.defaultNodeName) + "</a>";
                }(), function () {
                    return t.isJump && r.href ? '&nbsp;&nbsp;&nbsp;<p style="font-size:1pt" class="' + z + '"></p>' : '&nbsp;&nbsp;&nbsp;<p style="font-size:1pt" class="' + z + (r.disabled ? " " + d : "") + '">' + "</p>"
                }(), "</div>", function () {
                    if (!t.edit) return "";
                    var e = {
                        ...
                        url: '<i class="layui-icon layui-icon-edit" data-type="url"></i>',
        ...
        l.children(".layui-tree-btnGroup").on("click", ".layui-icon", function (l) {
            ...
            if ("add" == f) {
                ...
                var F = d.children("." + z).html();
                d.children("." + z).html(""), d.append('<input type="text" class="layui-tree-editInput">'), d.children(".layui-tree-editInput").val(F).focus();
                var j = function (e) {
                    var i = e.val().trim();
                    i = i ? i : r.text.defaultNodeName, e.remove(), d.children("." + z).html(i), g.data.title = i, r.operate && r.operate(g)
                };
                d.children(".layui-tree-editInput").blur(function () {
                    j(i(this))
                }), d.children(".layui-tree-editInput").on("keydown", function (e) {
